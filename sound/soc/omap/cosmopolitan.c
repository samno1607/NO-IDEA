...
//	printk("sdp4430_mcbsp_hw_params %d", be_id);
...
static struct snd_soc_card snd_soc_sdp4430 = {
	.name = "Cosmopolitan",
	.long_name = "LGE Cosmopolitan Board",
...
module_init(cosmopolitan_soc_init);
...
module_exit(cosmopolitan_soc_exit);

MODULE_AUTHOR("LG Electronics");
MODULE_DESCRIPTION("ALSA SoC COSMOPOLITAN");
MODULE_LICENSE("GPL");
