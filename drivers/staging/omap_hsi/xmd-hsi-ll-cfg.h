...
#define HSI_LL_AC_WAKE_TIMEOUT		2 * HZ
#define HSI_LL_CA_WAKE_TIMEOUT		2 * HZ


#define MIPI_HSI_CP_OPEN_CONN_ID_FOR_RETRY

#ifdef MIPI_HSI_CP_OPEN_CONN_ID_FOR_RETRY
#define MIPI_HSI_CP_MAX_OPEN_CONN_ID_RETRY	10
#else
#endif

#define MIPI_HSI_TTY_WRITE_TIMEOUT_FEATURE
#define MIPI_HSI_NET_WRITE_TIMEOUT_FEATURE
